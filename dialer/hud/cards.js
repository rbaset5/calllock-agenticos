...
export const NATIVE_STAGE_CARDS = {
  OPENER: {
    ...
    clarifyingQuestion: '',
    valueProp: "Captures the calls that come in after hours and during jobs — when nobody's available to answer.",
    proofPoint: "Most missed high-intent calls happen outside business hours. That's where jobs disappear.",
    toneVariants: {
  ...
  QUALIFIER: {
    ...
    clarifyingQuestion: "Is that something that's been getting worse as you've grown?",
    valueProp: 'Even two or three missed calls a month at your ticket size is real money.',
    proofPoint: 'Contractors running $2K+ average tickets lose $4-6K/month on just 2-3 missed calls.',
    toneVariants: {},
  },
  ...
  CLOSE: {
    ...
    valueProp: '15 minutes to see if it\'s worth it. If not, I\'ll leave you alone.',
    proofPoint: '$297/mo. One booked job covers it.',
    toneVariants: {},
  },
  ...
  NON_CONNECT: {
    ...
    primaryLine: "Hey {NAME}, Rashid calling from {LOCATION} — I work with contractors on what happens to their calls when they're tied up on a job. Worth a quick conversation. Call me back at {NUMBER}, or I'll try you again {DAY}.",
  ...
  MINI_PITCH: {
    ...
    backupLine: "We catch the calls that come in after 5 PM and on weekends — book the job before the customer calls someone else.",
...
export const NATIVE_OBJECTION_CARDS = {
  timing: {
    ...
    valueProp: 'Takes 15 minutes to set up. You could be live by end of week.',
    proofPoint: 'Every week without coverage is another week of missed jobs.',
  ...
  tried_ai: {
    ...
    primaryLine: "Fair enough — most of that early AI stuff was rough. What broke first — voice, booking, pricing, or something else?",
    ...
    listenFor: ['quality', 'booking', 'customers complained', 'robotic'],
    branchPreview: { engaged: { next: 'QUALIFIER' }, pushback: { next: 'EXIT' } },
    clarifyingQuestion: 'What broke first — voice, booking, pricing, or something else?',
    valueProp: 'Built for contractor calls — handles scheduling, dispatch, quoting. Not a generic chatbot.',
    proofPoint: 'Works with Housecall Pro, Jobber, or pen-and-paper. No ServiceTitan required.',
    toneVariants: {},
  },
  ...
  referral_only: {
    ...
    listenFor: ['voicemail', 'call back', 'miss some', 'covered'],
    branchPreview: { engaged: { next: 'QUALIFIER' }, pushback: { next: 'EXIT' } },
  ...
  competitor_comparison: {
    ...
    listenFor: ['messages', 'expensive', "doesn't book", 'satisfied'],
    branchPreview: { engaged: { next: 'QUALIFIER' }, pushback: { next: 'EXIT' } },
    clarifyingQuestion: "Are you happy with how it's working, or are there gaps?",
    valueProp: "Works with whatever you've got — not locked to ServiceTitan.",
    proofPoint: '$297/mo, unlimited calls. No per-minute billing.',
    toneVariants: {},
  },
};

...
export const NATIVE_STAGE_CARDS = {
  ...
  OBJECTION: {
    ...
    backupLine: 'Got it. What happens when two calls come in at once?',
  ...
  MINI_PITCH: {
    ...
    primaryLine: "We help contractors make sure inbound calls get handled when the team can't answer live.",
    backupLine: "We help contractors avoid losing jobs when calls come in and nobody can grab the phone.",
  ...
  PRICING: {
    ...
    valueProp: 'Captures jobs you already paid to generate.',
    proofPoint: 'This usually matters most when demand is already there and the issue is what happens after the phone rings.',
    toneVariants: {

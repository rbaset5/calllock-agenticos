...
def list_voice_call_records(
    *,
    ...
    if using_supabase():
        return supabase_repository.list_voice_call_records(tenant_id=tenant_id, created_since=created_since)
    return local_repository.list_voice_call_records(tenant_id=tenant_id, created_since=created_since)
...
def list_voice_tool_calls_for_period(
    *,
    ...
    if using_supabase():
        return supabase_repository.list_voice_tool_calls_for_period(tenant_id=tenant_id, created_since=created_since)
    return local_repository.list_voice_tool_calls_for_period(tenant_id=tenant_id, created_since=created_since)
...
def list_voice_config_snapshots_for_period(
    *,
    ...
    if using_supabase():
        return supabase_repository.list_voice_config_snapshots_for_period(
            tenant_id=tenant_id,
            created_since=created_since,
        )
    return local_repository.list_voice_config_snapshots_for_period(tenant_id=tenant_id, created_since=created_since)
...
def list_voice_safety_findings_for_period(
    *,
    ...
    if using_supabase():
        return supabase_repository.list_voice_safety_findings_for_period(
            tenant_id=tenant_id,
            created_since=created_since,
        )
    return local_repository.list_voice_safety_findings_for_period(tenant_id=tenant_id, created_since=created_since)

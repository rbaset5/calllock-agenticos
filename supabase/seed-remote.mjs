...
function record({
  id, callId, retellCallId, phone, transcript, fields, extractionStatus,
...
const records = [
  ...
  record({
    id: "aaaa0002-0000-0000-0000-000000000001",
  ...
  record({
    id: "aaaa0003-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0002-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0003-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0004-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0005-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0006-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0007-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0008-0000-0000-0000-000000000001",
  ...
  record({
    id: "bbbb0009-0000-0000-0000-000000000001",
  ...
  record({
    id: "cccc0002-0000-0000-0000-000000000001",
  ...
  record({
    id: "cccc0003-0000-0000-0000-000000000001",
  ...
  record({
    id: "cccc0004-0000-0000-0000-000000000001",
  ...
  record({
    id: "cccc0005-0000-0000-0000-000000000001",
  ...
  record({
    id: "cccc0006-0000-0000-0000-000000000001",
  ...
  record({
    id: "dddd0002-0000-0000-0000-000000000001",
  ...
  record({
    id: "eeee0002-0000-0000-0000-000000000001",
  ...
  record({
    id: "eeee0003-0000-0000-0000-000000000001",
  ...
  record({
    id: "eeee0004-0000-0000-0000-000000000001",
  ...
  record({
    id: "eeee0005-0000-0000-0000-000000000001",
...
// ── Step 3: Delete trigger-inserted callback_touches ─────────────────────────
console.log("Step 3: Replacing auto-triggered callback_touches…");
const { error: delTouchErr } = await supabase
  .from("callback_touches")
  .delete()
  .eq("tenant_id", TENANT_ALPHA)
  .like("call_id", "demo-call-%");
if (delTouchErr) { console.error("Delete touches failed:", delTouchErr); process.exit(1); }

// ── Step 4: Insert 10 callback_touches with precise timestamps ────────────────
const touches = [
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-013", outcome: "no_answer",     created_at: ago(7 * HR)  },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-014", outcome: "no_answer",     created_at: ago(11 * HR) },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-015", outcome: "no_answer",     created_at: ago(8 * HR)  },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-015", outcome: "no_answer",     created_at: ago(4 * HR)  },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-016", outcome: "left_voicemail",created_at: ago(6 * HR)  },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-017", outcome: "left_voicemail",created_at: ago(9 * HR)  },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-018", outcome: "left_voicemail",created_at: ago(10 * HR) },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-024", outcome: "no_answer",     created_at: ago(8 * HR)  },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-024", outcome: "left_voicemail",created_at: ago(5 * HR)  },
  { tenant_id: TENANT_ALPHA, call_id: "demo-call-028", outcome: "no_answer",     created_at: ago(6 * HR)  },
];

const { error: touchErr } = await supabase.from("callback_touches").insert(touches);
if (touchErr) { console.error("Touch insert failed:", touchErr); process.exit(1); }
console.log(`  ✓ Inserted ${touches.length} callback_touches`);
